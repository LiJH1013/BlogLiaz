...
关于前端、爬虫、AI 与 Python 工程的个人博客，偶尔也记录普通生活。

文章尽量写清过程、依据和适用范围。读者可以按技术方向浏览，也可以直接搜索标题、摘要和标签。

[开始阅读](https://lijh1013.github.io/BlogLiaz/) · [全部文章](https://lijh1013.github.io/BlogLiaz/articles/) · [RSS 订阅](https://lijh1013.github.io/BlogLiaz/rss.xml)
...
主要内容分为前端、爬虫、AI 和 Python。随笔不会单独抢占首页，只会偶尔出现在文章时间流里。

文章会持续更新。你可以直接访问网站，也可以通过 RSS 订阅新内容。

文章归档页可以按技术方向筛选。按 `/` 直接开始搜索，按 `Esc` 清空搜索并退出输入。每篇文章都带有目录、阅读进度、分享入口和上一篇、下一篇导航。

## 关于本站

野路子手记没有账户、广告和营销追踪。文章使用 Markdown 保存，网站源码公开在这个仓库中。
