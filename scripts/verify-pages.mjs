...
assert.match(home, /href="https:\/\/github\.com\/li-j-h"[^>]*aria-label="打开 LIAZ 的 GitHub 主页（新窗口）"|aria-label="打开 LIAZ 的 GitHub 主页（新窗口）"[^>]*href="https:\/\/github\.com\/li-j-h"/);
...
assert.match(sitemap, /https:\/\/li-j-h\.github\.io\/BlogLiaz\/hello/);
