...
assert.match(resources, /<span>Python<\/span><small>3<\/small>/);
assert.match(resources, /<strong>03<\/strong><span>Python<\/span>/);
assert.match(resources, /data-category="Python"/);
assert.match(resources, />PYTHON<\/span>/);
